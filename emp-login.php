...
<head>
  ...
  <!--This code for injecting an alert-->
      ...
      <style>
        ...
        .card card-border-color card-border-color-success{
          background-color: black;
        }
        .btn btn-danger btn-xl btn-block{
          background: green;
        }
        .splash-container{
          margin: 60px;
  ...
  <body class="be-splash-screen" background="assets/img/2.jpg">
    <div class="be-wrapper be-login">
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="assets/img/LL.jpg" alt="logo" width="{conf.logoWidth}" height="50"><span class="splash-description">Admin Login Panel</span></div>
              <div class="card-body">
